...
import LoadingDotIcon from "./app/components/LoadingDotIcon"
...
function html(x) {
  ...
  <html lang="en">
    <head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-172667871-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'UA-172667871-1');
    </script>
      <meta charset="UTF-8" />
