      ...
      switch (action.type){
        case "usernameImmediately":
          ...
          if (draft.username.value &&  !/^([a-zA-Z0-9]+)$/.test(draft.username.value) ){
            draft.username.hasErrors = true
            draft.username.message = "username can only accept regular numbers and figures"
          }
          return
        ...
        case "emailAfterDelay":
          if(!/^\S+@\S+$/.test(draft.email.value) ){
            ...
            draft.email.message = "You must provide a valid address"
          }
        ...
        case "passwordImmediately":
          ...
          if (draft.password.value.length > 50){
            ...
            draft.password.message = "password cannot exceed 50 character"
          }
          return
        case "passwordAfterDelay":
          if (draft.password.value.length < 6){
            draft.password.hasErrors = true
            draft.password.message = "password cannot be less than 6"
          }
          return
        case "submitForm":
