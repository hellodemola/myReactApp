...
function Chat() {
    ...
    useEffect(()=>{
       socket.current = io("process.env.BACKENDURL || 'https://backend-api-hd.herokuapp.com' ")
    ...
    return (
        ...
        <form onSubmit={handleSubmit} id="chatForm" className="chat-form border-top">
          <input value={state.fieldValue} onChange={handlerFieldChange} type="text" ref={chatField} className="chat-field" id="chatField" placeholder="Type a message…" autoComplete="off" />
        </form>
      </div>
    )
}
